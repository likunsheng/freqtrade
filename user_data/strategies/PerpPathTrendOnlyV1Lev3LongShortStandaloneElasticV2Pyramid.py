...
class PerpPathTrendOnlyV1Lev3LongShortStandaloneElasticV2Pyramid(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "5m"
    can_short = True
    ...
    pyramid_add_profit_trigger = 0.015
    pyramid_add_stake_fraction = 0.50
    ...
    def adjust_trade_position(
        ...
        **kwargs,
        ...
        if trade.nr_of_successful_entries >= 2:
            return None
        if current_profit < self.pyramid_add_profit_trigger:
            return None
        ...
        add_stake = float(trade.stake_amount) * float(self.pyramid_add_stake_fraction)
        ...
        if add_stake <= 0:
            return None
        return add_stake, "pyramid_add_long"
