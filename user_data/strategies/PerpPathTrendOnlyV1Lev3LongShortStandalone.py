...
class PerpPathTrendOnlyV1Lev3LongShortStandalone(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "5m"
    can_short = True
        ...
        **kwargs,
        ...
        if trade.is_short:
            if self.dp is not None:
                ...
                if df is not None and not df.empty and bool(df.iloc[-1].get("btc_regime_strong_up", False)):
                    return "trend_short_regime_flip"
